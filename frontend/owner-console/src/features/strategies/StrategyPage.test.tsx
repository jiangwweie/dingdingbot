...
beforeEach(() => {
  ...
  mockedGetControls.mockResolvedValue({
    ...
    dynamic_selection: { strategy_group_id: "SOR-001", selection_spec_id: "sor-dynamic-selection-v0", selection_mode: "static_baseline", pending_selection_mode: null, pending_effective_session_start_ms: null, control_version: 3 },
