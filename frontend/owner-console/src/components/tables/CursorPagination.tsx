...
export function CursorPagination({ hasNextPage, onNextPage }: CursorPaginationProps) {
  ...
  return (
    <div className="mt-2 flex min-h-[30px] items-center justify-between border border-[var(--color-divider)] bg-[var(--color-surface)] px-2">
      <span className="text-[11px] text-[var(--color-text-secondary)]">还有更多持久化 Signal</span>
