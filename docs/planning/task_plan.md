...
| 工作线 | 任务 | 工时 | 状态 | 依赖 |
|--------|------|------|------|------|
| **工作线 1** | 评分公式验证（诊断，不改代码） | 1-2h | ✅ 已完成 | - |
| 1.1 | 从数据库提取原始数据（signals 表） | 0.5h | ✅ 已完成 | - |
| 1.2 | 精细分组分析（0.05 间隔，20 档） | 0.5h | ✅ 已完成 | 1.1 |
| 1.3 | 拆解评分成分（wick_ratio, body_ratio, atr_ratio） | 0.5h | ✅ 已完成 | 1.1 |
| 1.4 | 模拟新评分公式 v2，验证相关性 | 0.5h | ✅ 已完成 | 1.2, 1.3 |
...
**详细报告**: `docs/diagnostic-reports/DA-20260419-001-score-correlation-analysis.md`
