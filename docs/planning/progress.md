...
**今日完成**:
1. ✅ 检查配置管理功能 3 项测试状态 (T2/T3/T4)
2. ✅ 确认所有测试已执行并通过 (75/75)
3. ✅ 修复 SignalRepository version 字段 UNIQUE 约束问题
4. ✅ 更新 task_plan.md，将订单管理级联展示功能记入待办

**待办事项更新**:
| 任务 | 优先级 | 状态 | 说明 |
|------|--------|------|------|
| 订单管理级联展示功能 | P1 | ☐ 待执行 | 树形展示订单链（ENTRY→TP1/TP2/SL） |
| 订单详情页 K 线渲染 | P1 | ✅ 已完成 | TradingView 升级，14/14 测试通过 |
