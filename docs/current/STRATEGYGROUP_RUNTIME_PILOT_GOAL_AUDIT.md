...
| Required order | The local contract verifies `dry_run -> chain_closure -> live_closure -> owner-console-source-readiness API`; Goal Status is generated by the dedicated PG-backed projector outside product-state refresh |
