...
| 5 | **Dual-Position Hard-Cap Account Risk Model V0** | **Owner-approved design; next medium-scale engineering program** | `docs/current/DUAL_POSITION_HARD_CAP_ACCOUNT_RISK_MODEL_V0_DESIGN.md`, `docs/current/DUAL_POSITION_HARD_CAP_ACCOUNT_RISK_MODEL_V0_IMPLEMENTATION_PLAN.md` |
