...
| P0 Standing Reduce-Only Recovery | Protection-failure recovery is standing-authorized but still gated by FinalGate and official Operation Layer | Main runtime window | local checkpoint complete | Deploy after local verification and keep the old owner-close confirmation path out of the primary runtime handoff |
