...
| 手工 repair 工具可修改 core Order/Position projection | 基线 `54169ca3` 的 `scripts/reconcile_terminal_core_order_projection.py`、`scripts/recover_runtime_exchange_*_projection.py` | 已作为 R7-5 首项退役；终态投影由 ticket-bound reconciler/lifecycle finalizer 承担 |
