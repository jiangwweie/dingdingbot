...
| StrategyGroup | Poll Cadence | Business Signal Validity | Candidate Evidence Freshness |
| --- | --- | --- | --- |
...
**Candidate Evidence Freshness note:** The `120s` value is watcher-side evidence
