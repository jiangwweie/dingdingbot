...
| RUNTIME-LT-001 | Multi-symbol runtime readiness | REVIEW | Codex | First hardening landed: order-watch running state is symbol-scoped and recent order-update evidence is symbol-indexed. Multi-symbol runtime remains blocked until reconciliation/read-model two-symbol fixture proof and separate Owner authorization. |
