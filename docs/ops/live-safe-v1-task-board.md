...
| P4-005 | Phase 4 non-real-live rehearsal design | TODO | Codex | Next task: design any future tiny-live-style non-real-live rehearsal under ADR-0009 with exact commands, caps, stop conditions, rollback path, and explicit statement that real live remains unauthorized. |
