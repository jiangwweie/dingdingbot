...
| ID | Task | Status | Owner | Notes |
| --- | --- | --- | --- | --- |
| PLC-LT-001 | Full PLC promotion ladder | REVIEW | Codex | Phase 0 local sandbox, Phase 1 read-only adapter, Phase 2 paper observation packet, and Phase 3 Binance testnet rehearsal are complete for review. Phase 4 tiny-live-style review remains blocked and requires separate Owner request, safety review, and authorization. |
