...
| ID | 任务 | 状态 | 依赖 | 负责人 |
|----|------|------|------|--------|
| 1 | 簇 A: ConfigRepository 创建 | 🔄 进行中 | 无 | backend-dev |
| 3 | 簇 A: 迁移脚本创建 | 🔄 进行中 | 无 | backend-dev |
| 2 | 簇 E: 信号状态枚举 | 🔄 进行中 | 无 | backend-dev |
...
| 6 | 簇 D: 配置管理页面 | ⏳ 待开始 | 13, 5, 9 | frontend-dev |
| 8 | 簇 D: Tooltip 组件 | ⏳ 待开始 | 无 | frontend-dev |
| 10 | 簇 D: 导入/导出交互 | ⏳ 待开始 | 13, 5, 9 | frontend-dev |
