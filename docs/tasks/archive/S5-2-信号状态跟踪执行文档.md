...
**创建文件**: `gemimi-web-front/src/components/SignalStatusBadge.tsx`
...
**修改文件**: `gemimi-web-front/src/pages/Signals.tsx` (或类似文件)
...
| `gemimi-web-front/src/lib/api.ts` | 修改 - 新增类型和调用 |
| `gemimi-web-front/src/components/SignalStatusBadge.tsx` | 创建 - 状态徽章组件 |
| `gemimi-web-front/src/pages/Signals.tsx` | 修改 - 集成状态显示 |
