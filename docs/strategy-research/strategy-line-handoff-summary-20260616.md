...
| `CCI-001` | **CCI trend escape / failure revival**。重点是 precious-metal +100 failure short，而不是 generic CCI。 | `research_candidate` | 金属 failure short full 2x `72.496535%`，best-90d 2x `105.400734%`；边界已固定在 `cci-asset-role-failure-boundary-20260616.md`。 | DD 2x `-74.614868%`，XAG 贡献集中，generic CCI 和权益 reclaim 衰减严重，不 handoff。 |
| `AEB-001` | **ATR expansion breakout short-window revival**。只保留 ATR24 equity expansion long，不是 broad ATR breakout。 | `research_candidate` | best-30d 2x `218.708454%`，full 2x `2.502514%`；边界已固定在 `aeb-atr-expansion-false-breakout-boundary-20260616.md`。 | best-90d 2x 只有 `31.950523%`，4 月后月度衰减明显，false-breakout 风险大，不 handoff。 |
| `STOCH-001` | **Stochastic range persistence / whipsaw vocabulary**。只保留 stochastic bullish range-persistence 的短窗口词汇，不做 broad oscillator activation。 | `parked_or_research_vocab` | best-30d 2x `246.716521%`、best-60d 2x `196.054074%`；边界已固定在 `stoch-whipsaw-range-persistence-boundary-20260616.md`。 | best-90d 2x 只有 `80.874239%`，full 2x `-90.790585%`，DD 2x `-95.696757%`，短边失败，不 handoff。 |
