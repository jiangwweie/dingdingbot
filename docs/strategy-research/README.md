...
| `hat-heikin-ashi-stop-reslot-boundary-20260616.md` | P2 supplement preserving `HAT-001` Heikin-Ashi green-run revival evidence while blocking handoff on drawdown, stop-fill/gap, HA smoothing lag, session/product/fill, and margin facts. |
...
| `main-control-strategy-cabinet-intake-sprint-20260616.md` | Main-control intake recommendation that shifts the next high-value step from broad pool expansion to Strategy Cabinet ingest, RequiredFacts registry, watcher observation state, SignalEvaluation shadow ledger, and Owner review queue. |
...
| `hat-heikin-ashi-stop-reslot-boundary-20260616.md` | `HAT-001` boundary that preserves Heikin-Ashi green-run / clean-combo / stop-reslot revival evidence while blocking handoff until drawdown, stop-fill/gap, HA smoothing lag, product/session/fill, and real-margin blockers improve. |
...
| `main-control-strategy-cabinet-intake-sprint-20260616.md` | Main-control intake recommendation that says the current 24-strategy cabinet should become observable through Strategy Picker, RequiredFacts registry, watcher shadow state, SignalEvaluation shadow ledger, and Owner review queue before broad expansion continues. |
