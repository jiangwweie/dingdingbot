...
3. Keep `ICH-001`, `CCI-001`, and `AEB-001` as research candidates with
   ...
   decay boundary, `CCI-001` has an asset-role / failure boundary, and
...
3. Treat `AEB-001` as a short-window volatility-expansion revival handle after
   `aeb-atr-expansion-false-breakout-boundary-20260616.md`; build false-breakout
