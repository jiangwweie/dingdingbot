...
async def _runtime_exchange_submit_gateway_binding(
    ...
    *,
    ...
    return await bind_runtime_exchange_submit_gateway(
        ...
        lifecycle_readonly=lifecycle_readonly,
    )


def _runtime_exchange_submit_gateway_env_blockers() -> list[str]:
    from src.infrastructure.runtime_exchange_gateway_binding import (
        runtime_exchange_submit_gateway_env_blockers,
    )

    return runtime_exchange_submit_gateway_env_blockers()


def _runtime_exchange_submit_gateway_status(gateway: Any) -> dict[str, Any]:
    from src.infrastructure.runtime_exchange_gateway_binding import (
        runtime_exchange_submit_gateway_status,
    )
