...
def _gap_matrix() -> list[BnbTrialReadinessGate]:
    rows = [
        (
            ...
            True,
            True,
            "pg_account_facts_current_projection",
        ...
        (
            ...
            True,
            True,
            "pg_operation_layer_symbol_cap_policy",
        ...
        (
            ...
            True,
            True,
            "pg_global_kill_switch_current_state",
        ...
        (
            ...
            True,
            True,
            "pg_runtime_startup_guard_preflight_state",
        ...
        (
            ...
            True,
            True,
            "pg_execution_permission_current_policy",
        ...
        (
            ...
            True,
            True,
            "pg_order_lifecycle_current_projection",
        ...
        (
            ...
            True,
            True,
            "pg_owner_risk_capital_policy_current",
        ...
        (
            ...
            True,
            True,
            "pg_symbol_side_notional_leverage_policy_current",
        ...
        (
            ...
            True,
            True,
            "pg_owner_attempt_position_loss_policy_current",
        ...
        (
            ...
            True,
            True,
            "pg_observation_case_mi001_bnb_case_001",
        ...
        (
            ...
            True,
            True,
            "pg_position_order_current_projection",
        ...
        (
            ...
            True,
            True,
            "pg_reconciliation_current_projection",
        ...
        (
            ...
            True,
            True,
            "pg_strategy_group_observations_and_operation_audit_current",
        ...
        (
            ...
            True,
            True,
            "pg_strategy_group_forward_review_windows",
        ...
        (
            ...
            True,
            True,
            "pg_owner_strategy_policy_decision_current",
        ...
        (
            ...
            False,
            True,
            "pg_owner_live_trial_authorization_current",
...
def _execution_boundary_audit() -> list[BnbExecutionBoundaryItem]:
    return [
        BnbExecutionBoundaryItem(
            ...
            authority_ref="pg_execution_intent_current_projection",
        ...
        BnbExecutionBoundaryItem(
            ...
            authority_ref="pg_order_lifecycle_current_projection",
        ...
        BnbExecutionBoundaryItem(
            ...
            authority_ref="pg_execution_permission_current_policy",
        ...
        BnbExecutionBoundaryItem(
            ...
            authority_ref="pg_runtime_control_surface_readmodel",
        ...
        BnbExecutionBoundaryItem(
            ...
            authority_ref="pg_strategy_group_live_observation_and_case_queue_readmodel",
...
def _source_refs() -> list[str]:
    return [
        "pg_strategy_group_observation_cases",
        "pg_strategy_trial_readiness_design",
        "pg_strategy_forward_review_rows",
        "pg_observation_case_queue_readmodel",
        "application_execution_permission_policy",
        "application_brc_operation_layer_boundary",
        "api_console_runtime_readmodel",
    ]
