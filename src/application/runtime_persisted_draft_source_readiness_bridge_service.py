"""Bridge persisted strategy-signal draft sources into submit readiness.

This is the RTF-015 non-executing bridge:

RuntimeStrategySignalIntentDraftSourcePacket
-> RuntimeNextAttemptStrategyPlanningPacket-compatible evidence
...
class RuntimePersistedDraftSourceReadinessBridgeService:
    ...
    async def preview_from_intent_draft_source(
        ...
        *,
        ...
        strategy_packet = strategy_planning_packet_from_intent_draft_source(
            intent_draft_source_packet
        )
        return await self._readiness.preview_from_strategy_planning_packet(
...
def strategy_planning_packet_from_intent_draft_source(
    source: RuntimeStrategySignalIntentDraftSourcePacket,
) -> RuntimeNextAttemptStrategyPlanningPacket:
    ...
    return RuntimeNextAttemptStrategyPlanningPacket(
        ...
        post_submit_finalize_packet_id=f"persisted-draft-source:{source.packet_id}",
        source_release_packet_id=f"persisted-draft-source:{source.packet_id}",
        status=status,
        ...
        operator_command_plan={
            "scope": "persisted_intent_draft_source_readiness_bridge",
            "next_step": (
        ...
        metadata={
            "source": "runtime_persisted_draft_source_readiness_bridge_service",
            "rtf015_persisted_draft_source_bridge": True,
            "non_executing": True,
