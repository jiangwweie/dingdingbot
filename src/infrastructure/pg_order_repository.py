...
class PgOrderRepository:
    ...
    def _order_to_response(order: Order) -> Dict[str, Any]:
        ...
        return {
            ...
            "local_reduce_only_intent": order.reduce_only,
            "exchange_reduce_only_param_sent": order.exchange_reduce_only_param_sent,
            "exchange_reduce_only_omit_reason": order.exchange_reduce_only_omit_reason,
    ...
    def _to_orm(order: Order) -> PGOrderORM:
        return PGOrderORM(
            ...
            runtime_instance_id=order.runtime_instance_id,
            trial_binding_id=order.trial_binding_id,
            strategy_family_id=order.strategy_family_id,
            strategy_family_version_id=order.strategy_family_version_id,
            signal_evaluation_id=order.signal_evaluation_id,
            order_candidate_id=order.order_candidate_id,
            ticket_id=order.ticket_id,
            exchange_command_id=order.exchange_command_id,
    ...
    def _to_domain(orm: PGOrderORM) -> Order:
        return Order(
            ...
            exchange_reduce_only_param_sent=orm.exchange_reduce_only_param_sent,
            exchange_reduce_only_omit_reason=orm.exchange_reduce_only_omit_reason,
            ...
            exchange_command_id=orm.exchange_command_id,
            account_id=orm.account_id,
            exchange_id=orm.exchange_id,
            exchange_instrument_id=orm.exchange_instrument_id,
            runtime_profile_id=orm.runtime_profile_id,
            strategy_group_id=orm.strategy_group_id,
            exposure_episode_id=orm.exposure_episode_id,
