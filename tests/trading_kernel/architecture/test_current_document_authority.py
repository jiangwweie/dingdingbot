...
CURRENT_PRODUCTION_COMMIT = "42d099cc"
CURRENT_PRODUCTION_TAG = "tokyo-runtime-2026.07.30.2"
CURRENT_LOCAL_CERTIFICATION = (
    "Finite-terminal-bracket domain and PostgreSQL Signal-to-Ticket regressions pass"
)
