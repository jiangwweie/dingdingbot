...
运行 `python .claude/skills/doc-manager/scripts/scan.py`
...
运行 `python .claude/skills/doc-manager/scripts/validate.py`
...
运行 `python .claude/skills/doc-manager/scripts/classify.py`
