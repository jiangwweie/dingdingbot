...
**角色总数**: 11 人（4 个决策角色 + 3 个执行角色 + 4 个支持角色）
...
| **支持层** | QA, Reviewer, Diagnostic, DevOps | 测试、审查、诊断、运维 |
...
- **核心原则**: **只改配置，不改代码**
- **专长**: 容器化部署、配置文件管理、日志分析、数据备份
- **触发场景**: 代码部署、配置调整、生产故障排查、数据库备份
...
| 文件路径 | PdM | Arch | PM | Coord | Frontend | Backend | QA | Reviewer | Diagnostic | DevOps |
|---------|-----|------|-----|-------|----------|---------|----|---------|------------|--------|
| `docs/products/**` | ✅ 全权 | ⚠️ 只读 | ⚠️ 只读 | ❌ | ❌ | ❌ | ❌ | 🔍 审查 | 🔍 审查 | ❌ |
| `docs/arch/**` | ⚠️ 只读 | ✅ 全权 | ⚠️ 只读 | ⚠️ 只读 | ❌ | ❌ | ❌ | 🔍 审查 | 🔍 审查 | ❌ |
| `docs/planning/**` | ⚠️ 只读 | ⚠️ 只读 | ✅ 全权 | ⚠️ 执行 | ❌ | ❌ | ❌ | 🔍 审查 | ✅ 全权 | ✅ 全权 |
...
| `config/**` | ❌ | 🔍 审查 | ❌ | ❌ | ❌ | ✅ 全权 | ❌ | 🔍 审查 | 🔍 审查 | ⚠️ 仅 `-prod` |
| `docker-compose.yml` | ❌ | ⚠️ 建议 | ❌ | ⚠️ 协调 | ❌ | ⚠️ 建议 | ❌ | 🔍 审查 | ❌ | ✅ 全权 |
| `Dockerfile` | ❌ | ⚠️ 建议 | ❌ | ⚠️ 协调 | ❌ | ⚠️ 建议 | ❌ | 🔍 审查 | ❌ | ✅ 全权 |
| `logs/**` | ❌ | ❌ | ⚠️ 查看 | ⚠️ 查看 | ⚠️ 查看 | ⚠️ 查看 | ❌ | 🔍 审查 | 🔍 审查 | ✅ 全权 |
| `data/*.db` | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ⚠️ 查询 | ✅ 全权 |
| `CLAUDE.md` | ❌ | ❌ | ⚠️ 建议 | ✅ 全权 | ❌ | ❌ | ❌ | 🔍 审查 | ❌ | ❌ |
| `.claude/team/**` | ⚠️ 建议 | ⚠️ 建议 | ⚠️ 建议 | ✅ 全权 | ⚠️ 建议 | ⚠️ 建议 | ⚠️ 建议 | 🔍 审查 | ❌ | ⚠️ 建议 |
