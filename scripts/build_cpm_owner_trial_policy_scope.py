...
OWNER_POLICY = {
    ...
    "watcher_symbol_scope": ["ETHUSDT", "SOLUSDT", "AVAXUSDT", "SUIUSDT"],
    "primary_live_submit_symbol_scope": ["ETHUSDT"],
    "expanded_watcher_scope_review": {
        "source_artifact": "latest-four-candidate-recent-live-submit-replay",
        "symbols": ["SOLUSDT", "AVAXUSDT", "SUIUSDT"],
        "scope_type": "read_only_watcher_scope_not_live_profile",
        "binance_usdm_confirmation_required_before_live_submit": True,
    },
    ...
    *,
    ...
    return {
        ...
        "checks": {
            ...
            "expanded_watcher_scope_ready": True,
