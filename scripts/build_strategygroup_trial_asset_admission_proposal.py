...
def build_trial_asset_admission_proposal(
    *,
    ...
    proposal = (
        _proposal(strategy_group_id=strategy_group_id, selected=selected, trial_packet=trial_packet)
    ...
    return {
        ...
        "owner_policy_checkpoint": {
            "owner_policy_required": bool(proposal),
    ...
    *,
    ...
    return {
        ...
        "proposed_tier_policy_row": {
            ...
            "reason": "Owner policy and scoped risk boundary required before armed observation",
        },
...
def _markdown(packet: dict[str, Any], output_json: Path) -> str:
    ...
    lines = [
        ...
        f"- Owner policy required: `{_yes_no(bool(proposal))}`",
