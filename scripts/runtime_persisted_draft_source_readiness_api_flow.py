#!/usr/bin/env python3
"""Call the non-executing persisted-draft-source readiness API."""
...
API_BASE_ENV = "RUNTIME_PERSISTED_DRAFT_SOURCE_READINESS_API_BASE"
...
def _request_body(args: argparse.Namespace) -> dict[str, Any]:
    body: dict[str, Any] = {
        ...
        "metadata": {
            "runtime_persisted_draft_source_readiness_api_flow": True,
    ...
    *,
    ...
    return api_client.request_json(
        ...
        (
            ...
            f"{args.runtime_instance_id}/persisted-draft-source-readiness-previews"
        ),
...
def _build_artifact(
    ...
    *,
    ...
    if http_status >= 300:
        return {
            "scope": "runtime_persisted_draft_source_readiness_api_flow",
            "status": "blocked",
            "blocked_stage": "persisted_draft_source_readiness_api",
            "runtime_instance_id": args.runtime_instance_id,
            "http_status": http_status,
            "api_payload": body,
            "blockers": [
                f"persisted_draft_source_readiness_api_http_{http_status}"
            ],
            "warnings": [],
    ...
    return {
        ...
        "operator_action_preview": {
            ...
            "executable_submit_ready": body.get("executable_submit_ready"),
        },
        "safety_invariants": _safety(),
    }
