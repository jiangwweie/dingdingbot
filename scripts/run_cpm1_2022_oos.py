"""
CPM-OOS-RUN-001: 2022 Full-year OOS Backtest Runner

Frozen baseline: CPM-1 (backtest_eth_baseline)
Period: 2022-01-01 00:00:00 UTC to 2022-12-31 23:59:59 UTC
...
async def main():
    ...
    # ── 2022 time window ──
    start_time_ms = 1640995200000  # 2022-01-01 00:00:00 UTC
    end_time_ms = 1672531199000    # 2022-12-31 23:59:59 UTC
    ...
    # ── Save artifacts ──
    artifact_dir = Path("reports/oos_runs/cpm1_2022_oos")
