...
def _live_closure_cutover_contract() -> dict[str, Any]:
    ...
    checks = {
        ...
        "live_closure_contract_requires_runtime_boundary_binding": (
            ...
            and "symbol_boundary_mismatch" in reject_reasons
            and "side_boundary_mismatch" in reject_reasons
            and "notional_boundary_mismatch" in reject_reasons
            and "leverage_boundary_mismatch" in reject_reasons
        ),
        "live_closure_contract_requires_exchange_acceptance": (
