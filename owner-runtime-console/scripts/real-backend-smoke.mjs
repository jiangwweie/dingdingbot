...
async function runConnectedSmoke(browser) {
  ...
  try {
    ...
    if (dryRunSummary?.scenario_count !== 11) {
      throw new Error("Expected source-readiness dry-run audit summary to include 11 scenarios");
    }
    ...
    await expectVisible(page, "11 项通过");
