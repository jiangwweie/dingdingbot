...
const scenarios = [
  { name: "normal", expected: ["当前阶段", "等待市场机会", "无需操作", "等待机会", "实盘边界", "8 项正常"] },
  { name: "processing", expected: ["当前阶段", "系统处理中", "处理中", "SOR 正在处理订单"] },
  { name: "paused", expected: ["当前阶段", "等待市场机会", "已暂停", "Owner 已暂停"] },
  { name: "intervention", expected: ["当前阶段", "需要介入", "事实不可用，暂不能使用"] },
  { name: "stale", expected: ["当前阶段", "工程状态暂不可用", "系统处理", "数据不可用，暂不能使用"] },
  { name: "empty", expected: ["当前阶段", "工程状态暂不可用", "状态暂不可用", "MPG"] },
