    ...
    if not _has_table("brc_live_signal_events"):
        op.create_table(
            ...
            sa.CheckConstraint(
                ...
                name="ck_brc_live_signal_source_kind",
            ),
            sa.CheckConstraint(
            ...
            sa.CheckConstraint(
                ...
                name="ck_brc_live_signal_event_time",
            ),
            sa.CheckConstraint(
                "created_at_ms <> event_time_ms AND created_at_ms >= event_time_ms",
                name="ck_brc_live_signal_no_generated_at_event_time",
            ),
            sa.CheckConstraint(
                "NOT (source_kind <> 'live_market' AND status = 'facts_validated' AND freshness_state = 'fresh')",
                name="ck_brc_live_signal_fresh_source",
            ),
            sa.UniqueConstraint(
                "strategy_group_id",
                "symbol",
