  ...
  it('shows the Owner execution trigger location when the final hard gate is clear but execution endpoint is not wired', async () => {
    ...
    mockBrcApi.bnbLiveExecutionBridgeDryRun.mockResolvedValueOnce({
      ...
      owner_execution_trigger: {
        ...
        visible: true,
        enabled: false,
        status: 'blocked_execution_readiness',
        endpoint: '/api/brc/owner-trial-flow/authorizations/auth-mi001-bnb/execute',
        reason: 'Generic Owner-operated execution endpoint is wired but blocked because PG-backed TP/SL protection price provenance is missing.',
        blockers: ['protection_price_source_missing'],
