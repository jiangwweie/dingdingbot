...
| `BRF2-001` | `admitted_trial_asset` | `not_tradable_facts` | `required_facts_mapping_gap` | `engineering` | `close_brf2_required_facts_mapping_for_armed_observation` | `armed_observation` |
