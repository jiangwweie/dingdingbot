...
- Candidate count: `2`
- Paper observation candidates: `1`
- Role-only candidates: `1`
...
| --- | --- | --- | --- | --- | --- |
| `BRF2-001` | `bear_rally_failure_right_tail_short` | `paper_observation_admission_candidate` | `intake_only` | `true` | `BRF2-001_paper_observation_admission_evidence` |
| `RBR2-001` | `range_upper_boundary_mean_reversion_short` | `role_only_intake_candidate` | `not_applicable` | `true` | `RBR2-001_role_only_range_detector_classifier_merge_note` |
