...
- 当前判断：主线暂未触发，但宽观察面已有观察级机会，需要评估是否扩展策略覆盖。
...
- Broader would-enter signals: `5`
- Broader actionable would-enter signals: `4`
- Broader low-priority would-enter signals: `1`
- Broader high-priority no-action signals: `3`
- Coverage gap: `True`
...
- Broader actionable would-enter exists: `True`
...
| --- | --- | --- | --- | --- |
| `MI-001` | `SOL/USDT:USDT` | `long` | `0.65` | `mi001_12h_momentum_impulse, observe_only_review_required` |
| `MI-001` | `BNB/USDT:USDT` | `long` | `0.65` | `mi001_12h_momentum_impulse, observe_only_review_required` |
| `CPM-RO-001` | `ETH/USDT:USDT` | `long` | `0.70` | `cpm_long_htf_trend_intact, cpm_long_pullback_depth_normal, cpm_long_reclaim_confirmed` |
| `BRF-001` | `BTC/USDT:USDT` | `short` | `0.64` | `brf_bear_rally_extended, brf_rally_high_rejected, brf_short_squeeze_risk_reviewed` |
...
- `review_broader_observe_only_signals_before_runtime_scope_change`
