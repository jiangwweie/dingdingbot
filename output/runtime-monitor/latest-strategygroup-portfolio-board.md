...
| `CPM-RO-001` | `L3` | `revise` | 18 | 4h:9/18+0p, 12h:11/18+0p, 24h:13/17+1p | `open_cpm_ro_semantic_source_merge_quality_review` |
...
| `CPM-RO-001` | `revise` | `open_cpm_ro_semantic_source_merge_quality_review` | would_enter_forward_outcome_pending:24h |
