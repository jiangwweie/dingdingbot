...
- Generated: `2026-07-01T16:23:57.656702+00:00`
...
| --- | --- | --- | --- | --- | --- | --- |
| `MPG-001` | `armed_observation` | `not_tradable_asset_admission` | `scope_not_attached` | `engineering` | `produce_scoped_live_observation_or_scope_proposal` | `armed_observation` |
...
| `MI-001` | `trial_asset_admission_candidate` | `not_tradable_policy` | `policy_scope_missing` | `owner` | `record_scoped_owner_policy` | `policy_scope_recorded` |
...
| `SOR-001` | `armed_observation` | `not_tradable_asset_admission` | `scope_not_attached` | `engineering` | `produce_scoped_live_observation_or_scope_proposal` | `armed_observation` |
