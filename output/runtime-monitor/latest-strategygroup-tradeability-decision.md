...
- Generated: `2026-07-02T07:25:34.499211+00:00`
...
| --- | --- | --- | --- | --- | --- | --- |
| `MPG-001` | `armed_observation` | `not_tradable_facts` | `watcher_tick_missing` | `runtime` | `refresh_or_repair_watcher_fact_source` | `watcher_tick_present` |
