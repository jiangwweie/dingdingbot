...
- Generated: `2026-06-29T14:12:30.386565+00:00`
...
| `CPM-RO-001` | `armed_observation` | `not_tradable_market_wait` | `fresh_cpm_long_signal_absent` | `market` | `continue_cpm_long_short_armed_observation_until_fresh_signal` | `live_submit_ready` |
