...
| MPG-001 | OPUSDT | candidate_scope_decision_pending | scope_not_attached | produce_scoped_live_observation_or_scope_proposal |
| MI-001 | AVAXUSDT | candidate_owner_policy_pending | policy_scope_missing | record_scoped_owner_policy |
| SOR-001 | ETHUSDT | candidate_scope_decision_pending | scope_not_attached | produce_scoped_live_observation_or_scope_proposal |
