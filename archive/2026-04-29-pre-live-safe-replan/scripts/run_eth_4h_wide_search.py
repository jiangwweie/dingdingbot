...
async def main():
    ...
    print("\n" + "=" * 70)
    print(f"ETH 4h 结果: 可行解 {len(feasible_results)}/{total}")
    print("=" * 70)
    ...
    if not feasible_results:
        ...
        print("\n" + "-" * 70)
        print("与 ETH 1h 对比:")
        print(f"  ETH 1h Best: ema=50, dist=0.005, pnl24=+5168, pnl25=+1645")
        print(f"  ETH 4h Best: ema={best['ema']}, dist={best['dist']:.3f}, pnl24={best['pnl_2024']:+.0f}, pnl25={best['pnl_2025']:+.0f}")
