...
async def test_pinbar_baseline():
    ...
    return report.total_trades, report.total_pnl, report.win_rate


if __name__ == "__main__":
    trades, pnl, wr = asyncio.run(test_pinbar_baseline())
    print(f"\n✅ Pinbar baseline: {trades} trades, PnL={pnl:.2f}, WR={wr*100:.2f}%")
