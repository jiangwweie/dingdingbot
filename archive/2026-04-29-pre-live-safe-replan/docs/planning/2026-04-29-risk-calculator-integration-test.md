...
**执行结果**:
- 核心回归测试: 63 passed, 0 failed
- 扩展回归测试: 73 passed, 0 failed (包含 risk_manager, risk_state_machine, risk_config_boundary)
- 覆盖率: 89%
...
*测试执行者: qa-tester Agent*
*报告更新: 2026-04-29 11:35*
