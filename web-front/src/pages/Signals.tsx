...
export default function Signals() {
  ...
  const renderCell = (signal: Signal, columnId: string) => {
    ...
    // Convert to Tokyo timezone (JST, UTC+9) to match Binance app display
    const tokyoTime = toZonedTime(new Date(signal.kline_timestamp || signal.created_at), 'Asia/Tokyo');
    const displayTime = format(tokyoTime, 'MM-dd HH:mm:ss', { locale: zhCN });
